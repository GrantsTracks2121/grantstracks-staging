...
<section class="bg-white dark:bg-gray-900">
  <div class="px-4 mx-auto max-w-screen-md">
      <p class="mb-8 lg:mb-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Do you have a suggestion? Did find find something you think needs to be changed? Or maybe you just want to say "Hi!" 😃 </br>Please fill in all the details below.</p>

  <form
        id="grantstracks-contact-form" 
        name="Grants-Tracks-Contact-Form"
        action="/thanks/"
        class="space-y-8" 
        netlify
  ...
  <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 dark:text-white sm:w-40" style="color: white">Send message</button>
      </form>
  </div>
</section>
